...
const projects = [
  {
    ...
    liveUrl: '#', // LIVE_DEMO_URL placeholder
    githubUrl: '#', // GITHUB_REPOSITORY_URL placeholder
    featured: true,
  },
  {
    id: 2,
        ...
        >
          ...
          <div className="mb-14">
            ...
            <p className="text-slate-400 text-base sm:text-lg max-w-2xl">
              Some of the projects I've built while learning and experimenting with modern web technologies.
            </p>
          </div>
                ...
                >
                  <div
                    className={`grid grid-cols-1 ${
                      isFeatured ? 'lg:grid-cols-12' : 'lg:grid-cols-12'
                    }`}
                  >
                    {/* Browser Window Mockup Preview */}
                    <div
                      className={`${
                        isFeatured ? 'lg:col-span-6' : 'lg:col-span-5'
                      } bg-slate-950 border-b lg:border-b-0 lg:border-r border-slate-800 flex flex-col`}
                    >
                      {/* Window Bar */}
                      ...
                      {/* Mockup Canvas */}
                      <div className="p-8 flex-1 min-h-[220px] flex flex-col justify-center items-center bg-gradient-to-br from-slate-900 via-slate-950 to-indigo-950/40 relative overflow-hidden group">
                        {/* Decorative UI Cards in Preview */}
                    ...
                    <div
                      className={`${
                        isFeatured ? 'lg:col-span-6' : 'lg:col-span-7'
                      } p-6 sm:p-8 flex flex-col justify-between space-y-6`}
                    >
                      <div>
